...
if (isset($_POST['update_profil'])) {
    ...
    if ($update) {
        ...
        $_SESSION['name'] = $nama;
        echo "<script>alert('Profil berhasil diperbarui!'); window.location='settings.php';</script>";
    } else {
...
<body>
    ...
    <div class="sidebar">
        <div class="menu">
            <h2 style="text-align:center; color:white; margin-bottom: 30px; font-family:'Playfair Display', serif;">Perpus Online</h2>
